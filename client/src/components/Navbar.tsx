...
const Navbar = () => {
  ...
  console.log("this is the authuser fetched", authUser);
      ...
      <div className="flex justify-between items-center w-full py-3 px-8 bg-primary-700 text-white ">
        ...
        {isDashboard && (
          ...
          {isDashboard && authUser && (
            <Button
              variant="secondary"
              className=" w-full md:ml-4  flex justify-center items-center bg-primary-50 text-primary-700 hover:bg-secondary-500 hover:text-primary-50"
              onClick={() =>
                router.push(
